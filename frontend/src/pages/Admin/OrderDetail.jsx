...
const EmptyState = () => (
  <div className="flex flex-col items-center justify-center py-20 text-center bg-white border border-gray-200 rounded-sm">
    ...
    <p className="text-sm font-bold text-gray-500 uppercase tracking-wider">Order data not found</p>
    <Link
      to="/admin/orderlist"
...
const ErrorState = ({ message }) => (
  <div className="flex flex-col items-center justify-center py-20 text-center border border-red-200 bg-red-50 rounded-sm">
    ...
    <p className="text-sm font-bold text-red-600 uppercase tracking-wider">Failed to load order</p>
    ...
    >
      ...
      <div className="flex items-start justify-between pb-6 border-b-2 border-black">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">arixco.com</p>
        </div>
...
const OrderDetail = () => {
  ...
  }, [selectedNextStatus, showCourierInput, courierData, order, requiresCourierInput, updateStatus, refetch]);

  const handlePaymentUpdate = useCallback(async (newStatus) => {
    try {
