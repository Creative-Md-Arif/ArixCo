...
const PlaceOrder = ({
  ...
  const [validateCuppon, { isLoading: isValidating }] = useValidateCupponMutation();
  ...
  const placeOrderHandler = useCallback(async () => {
    ...
    isShippingCalculating, onPlaceOrder, cartItems, effectivePaymentMethod, subtotal, 
    shippingCharge, finalTotalPrice, totalSavings, appliedCoupon, isManualPayment, 
    isSSLCommerz, onProceedToPayment, navigate, createOrder, initSSLCommerz, dispatch
  ]);
