...
const EmptyOrders = () => (
  <div className="py-20 sm:py-28 text-center">
    ...
    <Link to="/" className="inline-block mt-5 bg-black text-white font-mono font-black text-xs uppercase tracking-widest px-6 py-3 rounded-xl hover:bg-blue-600 transition-colors">
      Start Shopping
    </Link>
  </div>
);
  ...
  return (
    <div className="mt-[10px]  bg-white min-h-screen">
      ...
      <div className="border-b border-gray-100 bg-white sticky top-0 z-10">
        <div className="container mx-auto px-4 sm:px-6 py-3 flex items-center gap-1.5 font-mono text-[11px] sm:text-xs uppercase tracking-[0.18em]">
          ...
          <span className="text-gray-200">/</span>
          <span className="text-black font-bold">Order History</span>
        </div>
      </div>
