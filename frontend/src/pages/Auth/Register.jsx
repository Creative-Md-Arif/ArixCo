        ...
        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
          <div className="p-4 sm:p-5">
            ...
            <form onSubmit={submitHandler} className="space-y-3">
              <div className="group">
                <label htmlFor="reg-name" className="block text-[12px] font-medium text-gray-600 mb-1 ml-0.5">
                  Full Name
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-3 py-2.5 bg-gray-50 border ${
                      errors.username ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#007EFC]"
              ...
              <div className="group">
                <label htmlFor="reg-email" className="block text-[12px] font-medium text-gray-600 mb-1 ml-0.5">
                  Email Address
                </label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400 group-focus-within:text-[#007EFC] transition-colors">
              ...
              <div className="group">
                <label htmlFor="reg-password" className="block text-[12px] font-medium text-gray-600 mb-1 ml-0.5">
                  Password
                </label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400 group-focus-within:text-[#007EFC] transition-colors">
              ...
              <div className="group">
                <label htmlFor="reg-confirm-password" className="block text-[12px] font-medium text-gray-600 mb-1 ml-0.5">
                  Confirm Password
                </label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400 group-focus-within:text-[#007EFC] transition-colors">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pl-9 pr-10 py-2.5 bg-gray-50 border ${
                      errors.confirmPassword ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#007EFC]"
                    } rounded-lg text-gray-700 text-[13px] focus:bg-white outline-none transition-all duration-200`}
                  />
                  <button
                    type="button"
            ...
            <div className="mt-4 text-center">
              <p className="text-gray-500 text-[12px] font-medium">
                ...
                <Link to="/login" className="text-[#007EFC] font-bold hover:underline underline-offset-4 ml-1">
                  Log In
                </Link>
              </p>
            </div>
